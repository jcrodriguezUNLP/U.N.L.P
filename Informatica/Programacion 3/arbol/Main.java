...
public class Main {
        ...
        do {
            ...
            switch (option) {
                ...
                case 2:
                    ...
                    // Modificado el límite de niveles a 5
                    generarArbolDePruebas(tree, 5);
    ...
    private static void generarArbolDePruebas(BinaryTree<Integer> tree, int maxNiveles) {
        ...
        while (!cola.isEmpty() && nivelActual < maxNiveles) {
            ...
            for (int i = 0; i < nodosEnNivel; i++) {
                ...
                if (random.nextBoolean()) {
                    BinaryTree<Integer> hijoIzquierdo = new BinaryTree<>(random.nextInt(10));
                ...
                if (random.nextBoolean()) {
                    BinaryTree<Integer> hijoDerecho = new BinaryTree<>(random.nextInt(10));
