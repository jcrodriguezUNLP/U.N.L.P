// Escriba un programa que reserve en forma dinámica un arreglo de 100 caracteres.
// A continuación, lea 10 oraciones utilizando la función gets e informe para cada una de ellas la cantidad de letras 
